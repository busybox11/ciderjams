...
import { type ClientWireMessage, clientWireMessageSchema, roomParticipant } from "@ciderjams/proto";

import { log } from "./logger";
import { RoomRegistry } from "./registry";
import { type HubSocket, RoomSocketHub } from "./room-sockets";
...
export const app = new Elysia().get("/", () => "ciderjams sync\n").use(roomWs);
